...
vector<vector<char>> BDeadSquares(vector <BPawn> BPawns, vector <BRook> BRooks, vector <BKnight> BKnights, vector <BBishop> BBishops, vector<BQueen> BQueens, vector <BKing> BKings, vector <WPawn> WPawns, vector <WRook> WRooks, vector <WKnight> WKnights, vector <WBishop> WBishops, vector<WQueen> WQueens, vector <WKing> WKings){
    ...
    {
        board[get<1>(WPawns[i].coordinates)-1][get<0>(BPawns[i].coordinates)+1] = 'X';
        board[get<1>(WPawns[i].coordinates)-1][get<0>(BPawns[i].coordinates)-1] = 'X';
    }
    for (size_t i = 0; i < BPawns.size(); i++)
    {
        board[get<1>(BPawns[i].coordinates)][get<0>(BPawns[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < WRooks.size(); i++)
    {
        ...
        {
            board[WRooks[i].Predicthion[j][1]][WRooks[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < BRooks.size(); i++)
    {
        board[get<1>(BRooks[i].coordinates)][get<0>(BRooks[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < WKnights.size(); i++)
    {
        ...
        {
            board[WKnights[i].Predicthion[j][1]][WKnights[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < BKnights.size(); i++)
    {
        board[get<1>(BKnights[i].coordinates)][get<0>(BKnights[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < WBishops.size(); i++)
    {
        ...
        {
            board[WBishops[i].Predicthion[j][1]][WBishops[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < BBishops.size(); i++)
    {
        board[get<1>(BBishops[i].coordinates)][get<0>(BBishops[i].coordinates)] = 'X';
    }
    
    for (size_t i = 0; i < WQueens.size(); i++)
    {
        for (size_t j = 0; j < WQueens[i].Predicthion.size(); j++){
            board[WQueens[i].Predicthion[j][1]][WQueens[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < BQueens.size(); i++)
    {
        board[get<1>(BQueens[i].coordinates)][get<0>(BQueens[i].coordinates)] = 'X';
    }

    for (size_t i = 0; i < WKings.size(); i++)
    {
        for (size_t j = 0; j < WKings[i].Predicthion.size(); j++){
            board[WKings[i].Predicthion[j][1]][WKings[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < BKings.size(); i++)
    {
        board[get<1>(BKings[i].coordinates)][get<0>(BKings[i].coordinates)] = 'X';
    }
    return board;
}
...
vector<vector<char>> WDeadSquares( vector <BPawn> BPawns, vector <BRook> BRooks, vector <BKnight> BKnights, vector <BBishop> BBishops, vector<BQueen> BQueens, vector <BKing> BKings, vector <WPawn> WPawns, vector <WRook> WRooks, vector <WKnight> WKnights, vector <WBishop> WBishops, vector<WQueen> WQueens, vector <WKing> WKings){
    ...
    for (size_t i = 0; i < BPawns.size(); i++)
    {
        board[get<1>(BPawns[i].coordinates)+1][get<0>(BPawns[i].coordinates)+1] = 'X';
        board[get<1>(BPawns[i].coordinates)+1][get<0>(BPawns[i].coordinates)-1] = 'X';
    }
    for (size_t i = 0; i<WPawns.size(); i++){
        board[get<1>(WPawns[i].coordinates)][get<0>(WPawns[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < BRooks.size(); i++)
    {
        ...
        {
            board[BRooks[i].Predicthion[j][1]][BRooks[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < WRooks.size(); i++)
    {
        board[get<1>(WRooks[i].coordinates)][get<0>(WRooks[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < BKnights.size(); i++)
    {
        ...
        {
            board[BKnights[i].Predicthion[j][1]][BKnights[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < WKnights.size(); i++)
    {
        board[get<1>(WKnights[i].coordinates)][get<0>(WKnights[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < BBishops.size(); i++)
    {
        ...
        {
            board[BBishops[i].Predicthion[j][1]][BBishops[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < WBishops.size(); i++)
    {
        board[get<1>(WBishops[i].coordinates)][get<0>(WBishops[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < BQueens.size(); i++)
    {
        ...
        {
            board[BQueens[i].Predicthion[j][1]][BQueens[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < WQueens.size(); i++)
    {
        board[get<1>(WQueens[i].coordinates)][get<0>(WQueens[i].coordinates)] = 'X';
    }
    ...
    for (size_t i = 0; i < BKings.size(); i++)
    {
        ...
        {
            board[BKings[i].Predicthion[j][1]][BKings[i].Predicthion[j][0]] = 'X';
        }
    }
    for (size_t i = 0; i < WKings.size(); i++)
    {
        board[get<1>(WKings[i].coordinates)][get<0>(WKings[i].coordinates)] = 'X';
    }
    return board;
}
...
int main(){
    ...
    while(true){
        ...
        for (int i =0; i <BKings.size(); i++){
            BKings[i].Predicthion = BKings[i].predicthion(BKings[i].coordinates, board, BDeadSquares(BPawns, BRooks, BKnights, BBishops, BQueens, BKings, WPawns, WRooks, WKnights, WBishops, WQueens, WKings));
        }
        Turn = (Turn +1)%2;
        }
